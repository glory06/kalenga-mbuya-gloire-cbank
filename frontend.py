...
def page1():
    ...
    if len(name)!=0 and len(password)!=0:
        ...
        if result:
            ...
            button10 = Button(page1_frame, text="New Employee", command=create_employee, width=2000, height=2)
            button10.grid(row=0, pady=6)

            button11 = Button(page1_frame, text="Update detail", command=update_employee, width=2000, height=2)
            button11.grid(row=1, pady=6)

            button13 = Button(page1_frame, text="Show All Employee", command=show_employee, width=2000, height=2)
            button13.grid(row=2, pady=6)

            button11 = Button(page1_frame, text="Total Money", command=Total_money, width=2000, height=2)
            button11.grid(row=3, pady=6)

            button12 = Button(page1_frame, text="Back", command=back_to_main, width=2000, height=2)
...
def employee_login():
    def back_to_main3():
        ...
        button = Button(frame, text="Admin", command=admin_login)
        button.grid(row=0, pady=2000)

        button = Button(frame, text="Employee", command=employee_login)
        button.grid(row=1, pady=2000)

        button = Button(frame, text="Exit", command=tk.destroy)
        button.grid(row=2, pady=2000)
        tk.mainloop()
    ...
    employee_frame = Frame(tk, bg='green')
